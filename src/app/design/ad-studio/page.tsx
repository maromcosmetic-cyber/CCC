...
import { Loader2, Sparkles, Image as ImageIcon, LayoutTemplate, ArrowRight } from "lucide-react";
...
export default function AdStudioPage() {
    ...
    // Editor State
    // (Managed by AdCanvas internally for now, but background passed in)
    ...
    return (
        <div className="container py-6 space-y-6">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold tracking-tight">Ad Studio</h1>
                <p className="text-muted-foreground">
                    Create high-converting ads using brand data and AI strategy.
                </p>
            </div>
